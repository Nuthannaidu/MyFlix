...
import { loginUser, clearAuth } from '../../store/authSlice';
import { Film, Mail, Lock, Eye, EyeOff, Sparkles, CheckCircle2, AlertCircle } from 'lucide-react';
      ...
      <div className="relative z-10 flex justify-center items-center min-h-[calc(100vh-100px)] px-4 py-8">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/5 backdrop-blur-2xl rounded-3xl p-8 md:p-10 shadow-2xl border border-white/10 transform transition-all duration-500 hover:border-purple-500/30">
            ...
            {/* --- ERROR MESSAGE --- */}
            {error && (
              <div className="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20 backdrop-blur-sm animate-shake flex items-start gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button onClick={handleGoogleLogin} className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300 group">
              ...
              <button onClick={handleGithubLogin} className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300 group">
            ...
            <div className="mt-8 text-center">
              <p className="text-purple-200/60 text-sm">
                New to MyFlix?{' '}
                <Link to="/register" className="text-purple-400 hover:text-purple-300 font-semibold transition-colors underline decoration-purple-400/30 hover:decoration-purple-300">
                  Create an account
                </Link>
              </p>
            </div>
          ...
          <p className="text-center text-purple-300/40 text-xs mt-6">
            By continuing, you agree to MyFlix's Terms of Service and Privacy Policy
          </p>
        </div>
      </div>
